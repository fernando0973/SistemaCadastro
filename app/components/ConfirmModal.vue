        ...
        <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <!-- Icon for the modal type (danger/warning) -->
              <div :class="[
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button 
              ...
              :class="[
                ...
                type === 'danger' ? 'bg-red-600 hover:bg-red-700 focus:ring-red-500' : 'bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-500'
              ]"
            >
              {{ confirmText }}
            </button>
...
defineProps({
  ...
  message: {
    type: String,
    default: 'Tem certeza de que deseja realizar esta ação?'
  },
  confirmText: {
    type: String,
    default: 'Confirmar'
  ...
  type: {
    type: String,
    default: 'danger',
    validator: (value: string) => ['danger', 'warning'].includes(value)
  }
})
